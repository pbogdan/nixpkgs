{ stdenv, fetchurl, fetchpatch, autoconf213, pkgconfig, perl, python3, zip, buildPackages
, which, readline, zlib, icu67, cargo, rustc, rust-cbindgen, yasm, llvmPackages }:
...
in stdenv.mkDerivation {
  ...
  buildInputs = [ readline zlib icu67 ];
  nativeBuildInputs = [ autoconf213 pkgconfig
                        perl
                        which
                        python3
                        zip
